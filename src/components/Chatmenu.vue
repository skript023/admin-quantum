        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                <div class="form-control mb-4">
                    <label class="input input-bordered flex items-center gap-2">
                        ...
                        <input type="text" class="grow" placeholder="Search users..." v-model="searchQuery" />
                    </label>
                </div>
            ...
            <ul class="space-y-4">
                <li
                    ...
                    :key="contact.id"
                    class="flex items-center gap-4 p-3 rounded-lg cursor-pointer hover:bg-base-200 transition-colors duration-200 border border-base-300"

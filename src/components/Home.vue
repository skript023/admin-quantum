      ...
      <!-- Sidebar -->
        <aside
            ...
            <div class="mt-8">
                ...
                <!-- System Status -->
                <div class="mt-8">
                    <p class="text-sm font-semibold mb-2">SYSTEM STATUS</p>
                    <ul class="space-y-3">
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> Server Status</span>
                        <span class="text-sm font-medium">99.9%</span>
                        </li>
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> Database</span>
                        <span class="text-sm font-medium">Healthy</span>
                        </li>
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> API Response</span>
                        <span class="text-sm font-medium">156ms</span>
                        </li>
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-yellow-500 rounded-full mr-2"></span> Storage</span>
                        <span class="text-sm font-medium">78%</span>
                        </li>
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-yellow-500 rounded-full mr-2"></span> Memory Usage</span>
                        <span class="text-sm font-medium">65%</span>
                        </li>
                        <li class="flex justify-between items-center">
                        <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> Network</span>
        ...
        <div
            ...
            <main class="p-6 bg-base-100 min-h-screen">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div class="stats bg-base-100 shadow border-t-4 border-success">
                    <div class="stat">
                        <div class="stat-title">New Orders</div>
                        <div class="stat-value">2,345</div>
                        <div class="stat-desc text-success flex items-center"><i class="ph ph-arrow-up-right mr-1"></i>+12.5%</div>
                    </div>
                    </div>
        
                    <div class="stats bg-base-100 shadow border-t-4 border-error">
                    <div class="stat">
                        <div class="stat-title">Bounce Rate</div>
                        <div class="stat-value">23.4%</div>
                        <div class="stat-desc text-error flex items-center"><i class="ph ph-arrow-down-right mr-1"></i>-2.1%</div>
                    </div>
                    </div>
        
                    <div class="stats bg-base-100 shadow border-t-4 border-info">
                    <div class="stat">
                        <div class="stat-title">User Registrations</div>
                        <div class="stat-value">1,234</div>
                        <div class="stat-desc text-success flex items-center"><i class="ph ph-arrow-up-right mr-1"></i>+8.2%</div>
                    </div>
                    </div>
        
                    <div class="stats bg-base-100 shadow border-t-4 border-warning">
                    <div class="stat">
                        <div class="stat-title">Unique Visitors</div>
                        <div class="stat-value">12,456</div>
                        <div class="stat-desc text-success flex items-center"><i class="ph ph-arrow-up-right mr-1"></i>+15.3%</div>
                    </div>
                    </div>
                </div>
